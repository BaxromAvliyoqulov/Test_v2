    ...
    <div class="points-container">
        <div class="points-header">
            ...
            <div class="wallet-info">
                ...
                <p>Your Points: <strong class="gradient-text">{{ points }}</strong></p>
            </div>
        </div>
        ...
        <div class="shop-section">
            ...
            <button @click="goToFullFunctionalShop" class="button">Explore Shop</button>
        </div>
            ...
            <table class="points-table">
                ...
                <tbody>
                    <tr v-for="transaction in transactions" :key="transaction.id">
                        ...
                        <td :class="{ 'positive': transaction.points > 0, 'negative': transaction.points < 0 }">

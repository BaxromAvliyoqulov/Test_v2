<template>
    <div class="contact-container">
        <h2>If you have Some problems Please <span class="gradient-text">Contact Us</span></h2>
        <p class="subtitle">Hamkorlik yoki biror bir muammo yuzasidan bizga yozing</p>
